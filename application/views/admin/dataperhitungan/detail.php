...
<div class="page-content d-flex align-items-stretch"> 
  ...
  <nav class="side-navbar">
    ...
    <ul class="list-unstyled">
      ...
      <li class="active"><a href="<?=site_url('admin/DataPerhitungan/Perhitungan')?>"> <i class="icon-padnote"></i>Data Perhitungan </a></li>
          ...
          <div class="card">
            ...
            <!-- langkah 1 -->
              <div class="card-header d-flex align-items-center">
                <h5>Langkah 1 : Mengubah nilai dari hasil tes sesuai dengan nilai pada setiap kriteria dengan perbandingan</h5>
              </div>
              <table class="table">
                <thead align="center">
                  <tr>
            ...
            <!-- langkah 2 -->
              <div class="card-header d-flex align-items-center">
                <h5>Langkah 2 : Normalisasi nilai</h5>
              </div>
              <table class="table">
                <thead align="center">
                  <tr>
