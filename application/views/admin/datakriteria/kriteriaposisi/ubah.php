      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="<?= site_url('admin/DataKriteria/KriteriaPosisi/KriteriaPosisi/doEditKritPos/'.$edtpos['id_sie'])?>">

              <div class="card-header d-flex align-items-center">
              <h3 class="h4">Ubah Sie-Kepanitiaan <br><strong style="color:#0090d2;"><?=$edtpos['nama_kegiatan']?></strong></h3>
            </div>
            <br>
               <div class="form-group">
                <label class="form-control-label">Nama Sie-Panitia</label>
                <div>
                  <input type="text" class="form-control" name="nama_sie" placeholder="nama sie-panitia" value="<?= set_value('nama_sie', $edtpos['nama_sie']) ?>" required>
                </div>
              </div>
